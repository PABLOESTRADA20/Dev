...
const DISCUSSIONS = [
  {
    ...
    text: "La última versión trae mejoras significativas en cómo manejamos las asignaciones de memoria concurrentes. He estado probando el nuevo asignador en nuestras cargas de producción y los resultados son... interesantes.",
  ...
  },
  {
    ...
    text: "Con la estabilización de las Server Actions, la frontera entre cliente y servidor se difumina más que nunca. ¿Alguien sigue encontrando necesidad de React Query en aplicaciones pequeñas o medianas?",
  ...
  return (
    <div style={S.page}>
      ...
      <section style={S.hero}>
        <h1 style={S.h1}>
          Encuentra tu <br /><span style={S.h1span}>colectivo.</span>
        </h1>
        <p style={S.sub}>
          Conéctate con desarrolladores que construyen el futuro. Únete a hubs especializados de experiencia, desde programación de sistemas hasta ingeniería de UI de alto nivel.
        </p>
      </section>
      ...
      <section style={S.section}>
        <div style={S.sectionRow}>
          <div style={S.pulse}>
            ...
            <span style={S.sectionLabel}>Tendencias</span>
          </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "var(--text)" }}>
                    {c.members} miembros <span style={{ opacity: .4 }}>•</span> {c.online} en línea
                  </div>
                </div>
              </div>
        ...
        {DISCUSSIONS.map((d) => (
          <div key={d.title} style={{ ...S.card, display: "flex", flexDirection: "column", gap: 10 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, fontWeight: 700, flexWrap: "wrap" }}>
              ...
              <span style={{ color: "var(--text)" }}>Por <span style={{ color: "var(--text-h)" }}>{d.author}</span></span>
              <span style={{ opacity: .3, color: "var(--text)" }}>•</span>
      ...
      <section style={{ background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: 20, padding: 28, marginBottom: 48 }}>
        <div style={{ fontSize: 24, fontWeight: 900, letterSpacing: "-0.5px", color: "var(--text-h)", marginBottom: 8 }}>Construye junto a otros.</div>
